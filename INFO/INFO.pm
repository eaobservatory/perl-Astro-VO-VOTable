...
This class implements the INFO element from the VOTABLE DTD.
...
$Id: INFO.pm,v 1.1.1.7 2002/05/07 00:07:20 elwinter Exp $
...
sub new()
{
    ...
    # Reference to XML::DOM::Element object for the new VOTABLE::INFO
    # object.
    my($xmldom_element_this);

    # String with initial text for VOTABLE::INFO element.
    my($str);

    # Hash containing keyword-value pairs to initialize attributes of
    # the VOTABLE::INFO object.
    my(%attributes);
    ...
    # Reference to new VOTABLE::INFO object.
    my($this);
