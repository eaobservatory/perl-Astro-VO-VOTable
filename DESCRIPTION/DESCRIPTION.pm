...
Return a string containing the C<#PCDATA> content of the
C<DESCRIPTION> element. Return C<undef> if the element has no
C<#PCDATA> content, or an error occurs.

=head3 C<set($str)>

Set the C<#PCDATA> content of the C<DESCRIPTION> element to the
specified string. Use C<undef> as the argument to clear any existing
value of the text. Return the string on success, or C<undef> if an
error occurs.
...
#
# Revision 1.1.1.10  2002/06/05  00:00:12  elwinter
...
# of their arguments, the VOTABLE objecs, and the underlying XML::DOM
# object.
