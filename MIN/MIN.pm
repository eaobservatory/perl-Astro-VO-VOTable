...
VOTable::MIN - VOTable MIN element class
...
This class implements an interface to VOTable MIN elements. This class
...
Create and return a new VOTable::MIN object. Throw an exception if an
error occurs. If $arg is supplied, and is a XML::LibXML::Element
object for a 'MIN' element, that object is used to create the
VOTable::MIN object (just by reblessing).
...
Return the value of the 'value' attribute for this MIN
...
Set the value of the 'value' attribute for this MIN element to the
specified value. Throw an exception if an error occurs.

=head3 remove_value()

Remove the the 'value' attribute for this MIN element. Throw an
exception if an error occurs.

=head3 get_inclusive()

Return the value of the 'inclusive' attribute for this MIN
...
Set the value of the 'inclusive' attribute for this MIN element to the
specified value. Throw an exception if an error occurs. Currently
supported values are 'yes' and 'no'.

=head3 remove_inclusive()

Remove the the 'inclusive' attribute for this MIN element. Throw an
exception if an error occurs.
...
$Id: MIN.pm,v 1.1.1.13 2003/05/13 23:42:30 elwinter Exp $
...
#
# Revision 1.1  2002/09/11  14:08:38  elwinter
# Initial revision
#
